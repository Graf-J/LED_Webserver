...
class LED_Controller():
    def __init__(self):
        ...
        self.isRainbowCircleRunning = False
        self.isRainbowTheaterRunning = False
    ...
    # Circle Rainbow
    def showRainbowCircle(self, Strip, wait_ms):
        # Draw rainbow that fates across the Led-Strip on pixel after another
        self.isRainbowCircleRunning = True
        while self.isRainbowCircleRunning:
            for j in range(256):
                for i in range(Strip.numPixels()):
    ...
    # Theater Rainbow
    def showRainbowTheater(self, Strip, wait_ms):
        # Draw a Rainbow Circle with Theater Animation
        self.isRainbowTheaterRunning = True
        while self.isRainbowTheaterRunning:
            for j in range(256):
                for q in range(3):
